...
import { Pencil, Plus, Sparkles, Undo2, Waypoints, X } from "lucide-react"
...
// The task as it is now, read and drawn.
export function TaskView({ project, id }: { project: string; id: string }) {
...
// controls.
export function TaskAtRevision({ project, id, revision }: { project: string; id: string; revision: string }) {
...
// A new prompt in the bar, which goes with this task as the one the user has open.
