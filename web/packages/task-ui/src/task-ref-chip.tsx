...
const CHIP =
  "not-prose relative -top-px mx-0.5 inline-flex max-w-full items-center rounded-md border px-1.5 py-1 align-middle text-sm font-medium leading-4 no-underline transition-colors"
